...
export default {
  ...
  'Kokoro 本地': 'Kokoro Local',
  'Kokoro 英语配音包': 'Kokoro English voice pack',
  '英语本地配音': 'Local English narration',
  '英语美式与英式配音，仅在 Apple Silicon Mac 本机 CPU 运行。音色随应用提供。': 'US and UK English voices, running on the CPU of an Apple Silicon Mac. Voices are included with the app.',
  '默认音色': 'Default voice',
  '尚未选择': 'Not selected',
  '语速': 'Speaking speed',
  '试听播放失败': 'Preview playback failed',
  '仅支持 Apple Silicon Mac': 'Apple Silicon Mac only',
  '正在加载本地配音模型…': 'Loading the local voice model…',
  '正在生成本地配音…': 'Generating local narration…',
  '本地配音生成中 {pct}%': 'Generating local narration {pct}%',
  '已安装，使用时自动加载': 'Installed; loads automatically when used',
  '请先下载配音模型': 'Download the voice model first',
  '下载模型不会更改默认配音供应商。安装后无需 API Key，生成时不会联网下载。': 'Downloading does not change your default voice provider. No API key is needed after installation; generation never downloads files.',
  '试听使用固定英文示例，不保存到媒体池。': 'Preview uses a fixed English sample and is not saved to the media pool.',
  '停止试听': 'Stop preview',
  '试听音色': 'Preview voice',
  '模型不会自动安装。请点击下载；已生成的音频不会因删除模型而丢失。': 'Models are never installed automatically. Click Download; deleting a model does not remove generated audio.',
  '模型权重为 Apache-2.0；语音运行时包含 GPL eSpeak 组件，详见第三方声明。': 'Model weights are Apache-2.0; the speech runtime includes GPL eSpeak components. See the third-party notices.',
